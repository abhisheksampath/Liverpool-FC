...
echo "error – mysqli_error()";
 echo "Error number – mysqli_errorno()";
}
...
<div style="background-color: white;float:left;width:1200px">
...
<div id="player" style="background-color: white;float:left;margin-top: 0px;">
